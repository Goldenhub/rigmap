...
export default async function Home({ searchParams }: HomeProps) {
  ...
  const workspaces = await db.workspace.findMany({
    ...
    orderBy: (sort === 'popular' 
      ...
      : { createdAt: 'desc' as const }) as Prisma.WorkspaceOrderByWithRelationInput,
  });
      ...
      <div className="container py-12 max-w-screen-2xl mx-auto px-4 space-y-12">
        <div className="flex flex-col items-center text-center space-y-4 pt-16 pb-12">
          ...
          <p className="max-w-xl text-neutral-500 text-lg">
            A curated gallery of the world's most inspiring desk setups and creative spaces.
          </p>
          ...
          {!session && (
            <div className="pt-4">
              <Link
                href="/signup"
                className="bg-neutral-900 hover:bg-neutral-800 text-white px-8 py-3 rounded-full font-medium transition-all"
              >
                Join the community
              </Link>
            </div>
