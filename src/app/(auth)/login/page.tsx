    ...
    <div className="relative">
      ...
      <div className="space-y-8 relative">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <input
                ...
                placeholder="commander@setup.com"
              />
            </div>
            <div className="space-y-2">
              <label
        ...
        <div className="text-center text-sm font-bold text-neutral-500">
          ...
          <Link href="/signup" className="text-indigo-600 hover:text-indigo-400 transition-colors ml-1 underline decoration-2 underline-offset-4 decoration-indigo-200 hover:decoration-indigo-600">
            Create account
          </Link>
        </div>
      </div>
